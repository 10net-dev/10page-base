...
export function Map() {
  ...
  const googleMap = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.5774367388976!2d106.81272797552518!3d-6.187260893800331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f741c09d7649%3A0x9f7446414a44681!2sPasar%20Tanah%20Abang%20Blok%20A!5e0!3m2!1sid!2sid!4v1710210922679!5m2!1sid!2sid"

  return (
    <section className="text-gray-600 body-font relative">
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" height="100%" className="absolute inset-0" title="map"  scrolling="no" src={googleMap} style={{filter: "grayscale(1) contrast(1.2) opacity(0.4)"}}></iframe>
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <button className="text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
