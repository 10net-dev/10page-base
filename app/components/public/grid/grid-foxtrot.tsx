          ...
          <div className="grid grid-cols-2 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
              ...
              <section className="flex flex-col justify-center antialiased bg-gray-50 text-gray-600">
                <div className="h-full">
                  <div className="max-w-xs mx-auto">
                    <div className="relative bg-indigo-700 shadow-lg rounded-lg shadow-lg p-5 overflow-hidden">
                      ...
                      <div className="relative pt-[6.25rem] pb-14">
                        <div className="text-xs font-bold uppercase text-green-400 tracking-widest mb-2">Featured app</div>
                        <h3 className="text-2xl font-extrabold text-indigo-50 leading-snug mb-2">The easy way to scan your documents</h3>
                        <p className="text-indigo-200">Lorem ipsum dolor sit amet, consecte adipiscing elit sed do eiusmod.</p>
                      </div>
                      <div className="relative text-right">
                        <a className="inline-flex w-11 h-11 justify-center items-center bg-green-400 hover:bg-green-300 text-pink-50 hover:text-white rounded-full transition duration-150" href="#0"><span className="sr-only">Read more</span> <span className="font-bold -mt-px"></span></a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <figure>
              <div className="relative max-w-xl">
                <img className="w-full" width="1310" height="873" src={imageUrl} alt="Random image" />
                <div className="absolute inset-0 bg-primary opacity-60 rounded-md"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <h2 className="text-white text-3xl font-bold">Get Lost in Works</h2>
                </div>
                <p className="mt-5 text-lg font-medium leading-6 text-black">
                  Lavender ender
                </p>
