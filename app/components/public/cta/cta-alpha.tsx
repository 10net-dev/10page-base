...
export function Cta() {
  return (
    <div className="max-w-[80%] mx-auto rounded-[16px] bg-gradient-to-br from-primary via-blue-500 to-blue-200 py-[56px] px-[32px] justify-center text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]">
